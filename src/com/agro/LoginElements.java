...
/*
 * this is the class for initializing all the Web Elements
 */
...
public class LoginElements {
	...
	//this is the method to finding image on web-page
	...
	{
		return driver.findElement(By.cssSelector("body > app-root > app-login > div > div > div > div:nth-child(2) > div > img"));
	}
